...
<html>
        ...
        <body>
                <div class="container-fluid top">    
                    ...
                    <div class="container text-center" style="padding: 10vw">
                        <h3> <i class="fas fa-heart"></i></h3>
                    </div>
                      <div class="container">
                          <h2 class = "text-center" style="padding: 11ex" color="white">  We What We Do Our Talented Team crafts the best code and design amazing user experiences for our clients.
                          </h2>
                      </div>
