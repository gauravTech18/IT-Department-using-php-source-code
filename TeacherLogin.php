<?php
    ...
    if(isset($_POST['login']))
    {
      ...
      $sql = "select * from addteacher where username = '$username'
...
<html>
        ...
        <body>
            ...
            <form method="post" class="box"   onsubmit = "return validate()">
                <h1 style="font-family: 'Elsie Swash Caps', cursive;">TEACHER</h1>
    
                <input type="text" name="username" placeholder="UserName" class="form-control" autocomplete="off" >
                <input type="Password" name="password" placeholder="Password" class="form-control" autocomplete="off">
                 <input type="submit" name="login" value="Login" onclick ="validate()" class="btn btn-primary">
            </form>
