<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
          ...
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="First.php">First Year</a>
                <a class="dropdown-item" href="Second.php">Second Year</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="Third.php">Third Year</a>
              </div>
            </li>
      ...
      <h1 style="font-family: 'Londrina Shadow', cursive;" class="font1">Welcome To the information</h1>
        <h1 style="font-family: 'Londrina Shadow', cursive;" class="font1">Technology</h1>
      </div>
